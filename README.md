...
- 2時間ゲームジャム
- 作品発表
  - WebGLビルドができていればunityroomで
    - 登録したURLは[Trello](https://trello.com/c/j3nyRfgu/6-2%E6%99%82%E9%96%93%E3%82%B2%E3%83%BC%E3%83%A0%E3%82%B8%E3%83%A3%E3%83%A0%E4%BD%9C%E5%93%81)の2時間ゲームジャム作品カードにコメントで貼り付ける
  - WebGLビルドができないPCや、時間が20分ほどかかるので、無理な場合は共有ドライブにUnityプロジェクトをコピー
    - `Z:\2018年\ゲーム学科\学生用\gp1\2時間ゲームジャム`フォルダー内に名前フォルダーを作って、その中に見せるのに必要なファイルをコピーして提出

## 提出
- ゲームについてGoogleドキュメント2ページにまとめてTrelloで共有
  - 1ページ目
    - ゲームタイトル
    - サムネイル
    - ゲーム概要
...
## 春休み
- 日本ゲーム大賞の企画を考える
- 各自、テーマを決めて、それについて研究をする
  - 日本ゲーム大賞用の企画の試作を行う
  - paizaを極める
  - 1年生の講義内容を全て復習する
  - 3月開催予定のUnity1週間ゲームジャムに参加する
  - 何らかの勉強会でLT(ライトニングトーク)をする。「専門学校で1年学んだ成果」的な発表など
  - 勉強会に参加してレポートをまとめる
  - ブログを書く
  - etc...
...
- DATフェスタ作業
  - Photon Boltの実装
  - 2Dアクション。シーンの統合
  - ノベルとスバコディフェンスは引き続き完成に向けて作業

# 後期4回目
- DATフェスタ作業
  - Photon Boltの検討(結構難しいので仕上げてから)
  - 2Dアクション。水曜日に指示していた内容(当たり判定についての調査)の聞き取りから
  - ノベルとスバコディフェンスは引き続き完成に向けて作業
